from PyQt5.QtWidgets import (QApplication, QWidget, QLabel, QGridLayout, 
                            ...
                            QFrame, QStackedWidget, QSizePolicy, QWIDGETSIZE_MAX, QPushButton, QScrollArea)
...
class IndicesContent(ContentWidget):
    ...
    def init_scroll_view(self):
        ...
        # Use QScrollArea instead of custom scrolling
        ...
        # Set the scroll container's width
        ...
        # Add the main container to the scroll view layout
        ...
        # Configure scroller properties for optimal physics
        properties = QScrollerProperties()
        
        # Set physics parameters for natural feel
        properties.setScrollMetric(QScrollerProperties.DecelerationFactor, 1.0)
        properties.setScrollMetric(QScrollerProperties.DragStartDistance, 0.015)
        properties.setScrollMetric(QScrollerProperties.MinimumVelocity, 0.05)
        properties.setScrollMetric(QScrollerProperties.MaximumVelocity, 0.8)
    ...
    def reset_scroll_state(self):
        ...
        # Add initialization for velocity_samples to ensure complete state reset
